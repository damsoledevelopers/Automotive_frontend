...
const Sensors_ControlUnits = () => {
  ...
  const sensorCategories = generateCategoryWithProducts(
    sensorCategoriesBase.map((item, index) => ({
      ...item,
      id: item.id || (index + 1),
      link: item.link.startsWith('/catalog/part-p-') ? item.link : `/catalog/part-p-${21000 + index + 1}`
    })),
              ...
              {filteredProducts.map((category, index) => (
                <Link
                  ...
                  state={{ 
                    ...
                    category: { name: "Sensors Relay and Control Units", slug: "sensors_control_units" }
                  }}
