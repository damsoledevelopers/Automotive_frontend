  ...
  const products = [
    {
      ...
      freeDelivery: false,
      image: "https://boodmo.com/media/cache/catalog_image/images/categories/897accb.jpg",
      spareloChoice: true,
      class: "Interior Light Components",
    ...
    {
      id: 2,
      name: "INTERIOR LIGHT COMPONENTS ASSEMBLY",
      brand: "BOSCH",
      partNumber: "BOSCH-INTERIOR-LIGHT-COMPONENTS-12345",
      price: 1200.00,
      mrp: 1600.00,
      discount: 25,
      isOEM: false,
    ...
    },
    {
      ...
      name: "INTERIOR LIGHT COMPONENTS",
      brand: "PHILIPS",
      partNumber: "PHIL-INTERIOR-LIGHT-COMPONENTS-67890",
      price: 980.00,
      mrp: 1200.00,
      discount: 18,
      isOEM: false,
    ...
    {
      id: 4,
      name: "INTERIOR LIGHT COMPONENTS COMPLETE SET",
      brand: "HELLA",
      partNumber: "HELLA-INTERIOR-LIGHT-COMPONENTS-111",
      price: 1500.00,
      mrp: 2000.00,
      discount: 25,
      isOEM: false,
    ...
    {
      id: 5,
      name: "INTERIOR LIGHT COMPONENTS MODULE",
      brand: "VALEO",
      partNumber: "VALEO-INTERIOR-LIGHT-COMPONENTS-222",
      price: 750.00,
      mrp: 950.00,
      discount: 21,
      isOEM: false,
    ...
    {
      id: 6,
      name: "INTERIOR LIGHT COMPONENTS KIT",
      brand: "OSRAM",
      partNumber: "OSRAM-INTERIOR-LIGHT-COMPONENTS-9999",
      price: 1350.00,
      mrp: 1800.00,
      discount: 25,
      isOEM: false,
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
        ...
        <div className="mb-4 sm:mb-6">
          <h1 className="text-sm sm:text-lg md:text-xl lg:text-2xl font-bold text-gray-800 mb-2 sm:mb-3">
            Interior Light Components Parts
          </h1>
                ...
                >
                  <div className={`relative ${viewMode === "list" ? "w-48 h-48 flex-shrink-0" : "h-48"} bg-white border border-gray-100 rounded`}>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = "https://via.placeholder.com/200x150?text=Interior+Light+Components";
                      }}
                    />
                    {viewMode === "list" && (
                        ...
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1 pr-4">
                            ...
                            <div className="flex flex-wrap gap-1.5 text-[9px] sm:text-xs text-gray-600">
                              ...
                              <span>{product.class || "Interior Light Components"}</span>
                              <span className="text-gray-400">•</span>
...
export default InteriorLightComponents;
