  ...
  const products = [
    {
      ...
      freeDelivery: false,
      image: "https://boodmo.com/media/cache/catalog_image/images/categories/f80f19b.jpg",
      spareloChoice: true,
      class: "Number Plate Light",
    ...
    {
      id: 2,
      name: "NUMBER PLATE LIGHT ASSEMBLY",
      brand: "BOSCH",
      partNumber: "BOSCH-NUMBER-PLATE-LIGHT-12345",
      price: 1200.00,
      mrp: 1600.00,
      discount: 25,
      isOEM: false,
    ...
    },
    {
      ...
      name: "NUMBER PLATE LIGHT",
      brand: "PHILIPS",
      partNumber: "PHIL-NUMBER-PLATE-LIGHT-67890",
      price: 980.00,
      mrp: 1200.00,
      discount: 18,
      isOEM: false,
    ...
    {
      id: 4,
      name: "NUMBER PLATE LIGHT COMPLETE SET",
      brand: "HELLA",
      partNumber: "HELLA-NUMBER-PLATE-LIGHT-111",
      price: 1500.00,
      mrp: 2000.00,
      discount: 25,
      isOEM: false,
    ...
    {
      id: 5,
      name: "NUMBER PLATE LIGHT MODULE",
      brand: "VALEO",
      partNumber: "VALEO-NUMBER-PLATE-LIGHT-222",
      price: 750.00,
      mrp: 950.00,
      discount: 21,
      isOEM: false,
    ...
    {
      id: 6,
      name: "NUMBER PLATE LIGHT KIT",
      brand: "OSRAM",
      partNumber: "OSRAM-NUMBER-PLATE-LIGHT-9999",
      price: 1350.00,
      mrp: 1800.00,
      discount: 25,
      isOEM: false,
                ...
                >
                  <div className={`relative ${viewMode === "list" ? "w-48 h-48 flex-shrink-0" : "h-48"} bg-white border border-gray-100 rounded`}>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = "https://via.placeholder.com/200x150?text=Number+Plate+Light";
                      }}
                    />
                    {viewMode === "list" && (
                        ...
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1 pr-4">
                            ...
                            <div className="flex flex-wrap gap-1.5 text-[9px] sm:text-xs text-gray-600">
                              ...
                              <span>{product.class || "Number Plate Light"}</span>
                              <span className="text-gray-400">•</span>
...
export default NumberPlateLight;
