...
const Steering = () => {
 const steeringCategoriesBase = [
  ...
  const steeringCategories = generateCategoryWithProducts(
    steeringCategoriesBase.map((item, index) => ({
      ...item,
      id: item.id || (index + 1),
      link: item.link.startsWith('/catalog/part-p-') ? item.link : `/catalog/part-p-${22000 + index + 1}`
    })),
    "Steering",
    1800
  );
              ...
              {filteredProducts.map((category, index) => (
                <Link
                  ...
                  state={{ 
                    ...
                    category: { name: "Steering", slug: "steering" }
                  }}
