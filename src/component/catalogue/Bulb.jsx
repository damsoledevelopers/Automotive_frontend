  ...
  const products = [
    {
      ...
      freeDelivery: false,
      image: "https://boodmo.com/media/cache/catalog_image/images/categories/592779e.jpg",
      spareloChoice: true,
      class: "Bulb",
    ...
    {
      id: 4,
      name: "BULB COMPLETE SET",
      brand: "HELLA",
      partNumber: "HELLA-BULB-111",
      price: 1500.00,
      mrp: 2000.00,
      discount: 25,
      isOEM: false,
                ...
                >
                  <div className={`relative ${viewMode === "list" ? "w-48 h-48 flex-shrink-0" : "h-48"} bg-white border border-gray-100 rounded`}>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = "https://via.placeholder.com/200x150?text=Bulb";
                      }}
                    />
                    {viewMode === "list" && (
