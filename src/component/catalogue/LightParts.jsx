  ...
  const products = [
    {
      ...
      freeDelivery: true,
      image: "https://boodmo.com/media/cache/catalog_image/images/categories/53380d3.webp",
      spareloChoice: true,
      class: "Light",
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
          <div className="w-full lg:w-64 flex-shrink-0 space-y-4 order-2 lg:order-1">
            ...
            <div className="bg-white p-4 sm:p-5 rounded-lg shadow-sm border border-gray-100 sticky top-20">
              ...
              <div className="mb-4">
                <h4 className="font-semibold text-[9px] sm:text-xs text-gray-800 mb-2">Fulfilled by Sparelo</h4>
                <label className="flex items-center cursor-pointer">
                  <input
                    type="checkbox"
          ...
          <div className="flex-1 order-1 lg:order-2">
            <h2 className="text-base sm:text-lg md:text-xl font-bold text-gray-800 mb-4 sm:mb-6">Light</h2>
                ...
                >
                  <div className={`relative ${viewMode === "list" ? "w-48 h-48 flex-shrink-0" : "h-48"} bg-white border border-gray-100 rounded`}>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = "https://via.placeholder.com/200x150?text=Light";
                      }}
                    />
                    {viewMode === "list" && (
                        ...
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1 pr-4">
                            ...
                            <div className="flex flex-wrap gap-1.5 text-[9px] sm:text-xs text-gray-600">
                              ...
                              <span>{product.class || "Light"}</span>
                              <span className="text-gray-400">•</span>
                              <span>Sold By: {product.soldBy || "Bengaluru/BPN"}</span>
                              <span className="text-gray-400">•</span>
                              <span>{product.origin || "Aftermarket"}</span>
                            </div>
                          </div>
