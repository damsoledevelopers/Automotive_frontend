...
const TimingBeltKit = () => {
  ...
  // Mock products data for Timing Belt Kit
  const products = [
    {
      id: 1,
      name: "TIMING BELT KIT",
      brand: "TATA",
      partNumber: "885500050002",
      price: 799.00,
      mrp: null,
      discount: 0,
      isOEM: true,
    ...
    {
      id: 2,
      name: "BELT KIT FOR INDIGO CS / INDICA / INDIGO",
      brand: "GATES",
      partNumber: "885500070002",
      price: 3345.00,
      mrp: null,
      discount: 0,
      isOEM: true,
    ...
    {
      id: 6,
      name: "TIMING BELT KIT WITH TENSIONER",
      brand: "DAYCO",
      partNumber: "DAYCO-KIT-9999",
      price: 5500.00,
      mrp: 6500.00,
      discount: 15,
      isOEM: false,
  ...
  const totalParts = 2380; // Total parts count as shown in image
                ...
                >
                  ...
                  <div className={`relative ${viewMode === "list" ? "w-48 h-48 flex-shrink-0" : "h-48"} bg-white border border-gray-100 rounded`}>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        e.target.src =
                          "https://via.placeholder.com/200x150?text=Timing+Belt+Kit";
                      }}
                    />
                        ...
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1 pr-4">
                            ...
                            <div className="flex flex-wrap gap-1.5 text-[9px] sm:text-xs text-gray-600">
                              ...
                              <span>{product.class || "Timing Belt Kit"}</span>
                              <span className="text-gray-400">•</span>
