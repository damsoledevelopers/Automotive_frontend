  ...
  const products = [
    {
      ...
      freeDelivery: false,
      image: "https://boodmo.com/media/cache/catalog_image/images/categories/7f56283.jpg",
      spareloChoice: true,
      class: "Indicator",
    ...
    {
      id: 2,
      name: "INDICATOR ASSEMBLY",
      brand: "BOSCH",
      partNumber: "BOSCH-INDICATOR-12345",
      price: 1200.00,
      mrp: 1600.00,
      discount: 25,
      isOEM: false,
    ...
    },
    {
      ...
      name: "INDICATOR",
      brand: "PHILIPS",
      partNumber: "PHIL-INDICATOR-67890",
      price: 980.00,
      mrp: 1200.00,
      discount: 18,
      isOEM: false,
    ...
    {
      id: 4,
      name: "INDICATOR COMPLETE SET",
      brand: "HELLA",
      partNumber: "HELLA-INDICATOR-111",
      price: 1500.00,
      mrp: 2000.00,
      discount: 25,
      isOEM: false,
    ...
    },
    {
      ...
      brand: "VALEO",
      partNumber: "VALEO-INDICATOR-222",
      price: 750.00,
      mrp: 950.00,
      discount: 21,
      isOEM: false,
    ...
    },
    {
      ...
      name: "INDICATOR KIT",
      brand: "OSRAM",
      partNumber: "OSRAM-INDICATOR-9999",
      price: 1350.00,
      mrp: 1800.00,
      discount: 25,
      isOEM: false,
                ...
                >
                  <div className={`relative ${viewMode === "list" ? "w-48 h-48 flex-shrink-0" : "h-48"} bg-white border border-gray-100 rounded`}>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = "https://via.placeholder.com/200x150?text=Indicator";
                      }}
                    />
                    {viewMode === "list" && (
                        ...
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1 pr-4">
                            ...
                            <div className="flex flex-wrap gap-1.5 text-[9px] sm:text-xs text-gray-600">
                              ...
                              <span>{product.class || "Indicator"}</span>
                              <span className="text-gray-400">•</span>
