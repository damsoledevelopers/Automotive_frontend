  ...
  const products = [
    {
      ...
      freeDelivery: true,
      image: "https://boodmo.com/media/cache/catalog_image/images/categories/e8cb288.jpg",
      spareloChoice: true,
      class: "Clutch",
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
          ...
          <div className="flex-1 order-1 lg:order-2">
            <h2 className="text-base sm:text-lg md:text-xl font-bold text-gray-800 mb-4 sm:mb-6">Clutch</h2>
                ...
                >
                  <div className={`relative ${viewMode === "list" ? "w-48 h-48 flex-shrink-0" : "h-48"} bg-white border border-gray-100 rounded`}>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = "https://via.placeholder.com/200x150?text=Clutch";
                      }}
                    />
                    {viewMode === "list" && (
                        ...
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1 pr-4">
                            ...
                            <div className="flex flex-wrap gap-1.5 text-[9px] sm:text-xs text-gray-600">
                              ...
                              <span>{product.class || "Clutch"}</span>
                              <span className="text-gray-400">•</span>
