      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
          ...
          <div className="flex-1 order-1 lg:order-2">
            <h2 className="text-base sm:text-lg md:text-xl font-bold text-gray-800 mb-4 sm:mb-6">Brake</h2>
                ...
                >
                  <div className={`relative ${viewMode === "list" ? "w-48 h-48 flex-shrink-0" : "h-48"} bg-white border border-gray-100 rounded`}>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = "https://via.placeholder.com/200x150?text=Brake";
                      }}
                    />
                    {viewMode === "list" && (
