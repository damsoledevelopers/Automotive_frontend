  ...
  const products = [
    {
      ...
      freeDelivery: false,
      image: "https://boodmo.com/media/cache/catalog_image/images/categories/bd71bdc.jpg",
      spareloChoice: true,
      bestOffer: false,
      class: "V-belt",
    ...
    {
      id: 2,
      name: "V-BELT MULTI RIB",
      brand: "CONTITECH",
      partNumber: "CT-VB-6789",
      price: 650.00,
      mrp: 800.00,
      discount: 19,
      isOEM: false,
    ...
    {
      id: 3,
      name: "V-BELT SERPENTINE",
      brand: "BANDO",
      partNumber: "BANDO-VB-1111",
      price: 750.00,
      mrp: 900.00,
      discount: 17,
      isOEM: false,
                ...
                >
                  <div className={`relative ${viewMode === "list" ? "w-48 h-48 flex-shrink-0" : "h-48"} bg-white border border-gray-100 rounded`}>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = "https://via.placeholder.com/200x150?text=V-belt";
                      }}
                    />
                    {viewMode === "list" && (
                        ...
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1 pr-4">
                            ...
                            <div className="flex flex-wrap gap-1.5 text-[9px] sm:text-xs text-gray-600">
                              ...
                              <span>{product.class || "V-belt"}</span>
                              <span className="text-gray-400">•</span>
